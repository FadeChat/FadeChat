...
public class ServerInfo {
	...
	public static String ClientId="";				//User name 을 가질 String type 의 ID

	public static final String UserName="DM";				//Rabbitmq 의 username
	public static final String PassWord="DM";				//Rabbitmq 의 password
	

	public static  String EXCHANGE="";					//Server Exchange 이름


	public static  String Queue="";						//Server Queue 이름
